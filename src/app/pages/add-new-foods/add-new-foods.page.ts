...
export class AddNewFoodsPage implements OnInit {
  ...
  opemCamera(type) {
    ...
    // Necesitamos una opción para emplazar una imagen de comida desde el Explorador de Windows
  }
  ...
  submit() {
    ...
    /*
    O bien, precargar una imagen en hard-code para las fotos de los alimentos
    ...
    */
    ...
    if (this.isEdit) {
      ...
      const parma = {
        ...
        // Need to send something here for the submit
